...
RockyardKV targets on-disk format compatibility with C++ RocksDB v10.7.5.
...
Use the golden test suite to validate that C++ RocksDB v10.7.5 reads files created by RockyardKV.
...
| Durability semantics | Crash durability contracts | Crash tests + whitebox tests | `docs/status/durability_report.md`, `cmd/crashtest/`, `cmd/stresstest/` |
