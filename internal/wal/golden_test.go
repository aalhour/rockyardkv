...
func TestGoldenWALSimple(t *testing.T) {
	goldenPath := filepath.Join("..", "..", "testdata", "rocksdb", "v10.7.5", "formats", "wal", "simple.log")
...
func TestGoldenWALMulti(t *testing.T) {
	goldenPath := filepath.Join("..", "..", "testdata", "rocksdb", "v10.7.5", "formats", "wal", "multi.log")
	data, err := os.ReadFile(goldenPath)
	if err != nil {
		t.Skipf("Golden file not found: %v (run golden fixture generation first)", err)
	}
...
func TestGoldenWALFragmented(t *testing.T) {
	goldenPath := filepath.Join("..", "..", "testdata", "rocksdb", "v10.7.5", "formats", "wal", "fragmented.log")
	data, err := os.ReadFile(goldenPath)
	if err != nil {
		t.Skipf("Golden file not found: %v (run golden fixture generation first)", err)
	}
