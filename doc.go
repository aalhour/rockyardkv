// doc.go implements package documentation.
...
//
//	import "github.com/aalhour/rockyardkv"
//
...
//
//	// Delete data
//	err = database.Delete(rockyardkv.DefaultWriteOptions(), []byte("key"))
//
// # Batch Writes
//
...
//	wb.Delete([]byte("key3"))
//	err := database.Write(rockyardkv.DefaultWriteOptions(), wb)
//
// # Iteration
//
// Iterate over keys in sorted order:
//
//	iter := database.NewIterator(rockyardkv.DefaultReadOptions())
//	defer iter.Close()
//
...
//
//	cf, err := database.CreateColumnFamily(rockyardkv.ColumnFamilyOptions{}, "mycf")
//	if err != nil {
//	    log.Fatal(err)
//	}
//
//	err = database.PutCF(rockyardkv.DefaultWriteOptions(), cf, []byte("key"), []byte("value"))
