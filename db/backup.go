...
// This file implements BackupEngine for creating and managing database backups.
//
...
func (be *BackupEngine) getNextBackupID() (uint32, error) { //nolint:unparam // Error return kept for API consistency
	infos, err := be.GetBackupInfo()
	if err != nil {
		return 1, nil // Start with 1 if no backups exist
	}
