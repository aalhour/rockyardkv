...
func TestPrefixSeekBasic(t *testing.T) {
	...
	opts.PrefixExtractor = rockyardkv.NewFixedPrefixExtractor(4) // "user" prefix
...
func TestPrefixSeekWithPrefixSameAsStart(t *testing.T) {
	...
	opts := rockyardkv.DefaultOptions()
	opts.CreateIfMissing = true
	opts.PrefixExtractor = rockyardkv.NewFixedPrefixExtractor(3) // 3-byte prefix
...
func TestPrefixSeekEmpty(t *testing.T) {
	...
	opts := rockyardkv.DefaultOptions()
	opts.CreateIfMissing = true
	opts.PrefixExtractor = rockyardkv.NewCappedPrefixExtractor(4)
